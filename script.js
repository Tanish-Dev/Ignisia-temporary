...
(function initGalleryToggle() {
  function applyToggle() {
    const galleryEl = document.getElementById('gallery') || document.getElementById('about-gallery');
...
const committeeMembers = [
  { id: 1, name: "Vivaan Mathur", role: "President", imagePath: "assets/images/gallery/VIVAAN.webp" },
  { id: 2, name: "Ansh Thakare", role: "Principal Coordinator", imagePath: "assets/images/gallery/ANSH.webp" },
  { id: 3, name: "Anushka Wani", role: "General Secretary", imagePath: "assets/images/gallery/ANUSHKA.webp" },
  { id: 4, name: "Janavi Honrao", role: "Media Head", imagePath: "assets/images/gallery/JAANVI.webp" },
...
(function initTimelineModals() {
  ...
  function openModal(modalId, triggerBtn) {
    ...
    const modalBody = targetModal.querySelector('.timeline-modal-body');
